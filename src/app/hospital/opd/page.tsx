        ...
        <div className="bg-slate-50" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            ...
            <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-900 to-teal-900 mix-blend-multiply opacity-90 z-10" />
                    <Image 
                        src="/carousel-2.png"
                        alt="OPD Services"
                        fill
                ...
                <div className="relative z-20 text-center px-6 max-w-4xl mx-auto -mt-8">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-blue-50 font-medium font-montserrat drop-shadow-md">
