                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                                            selectedWing === key ? "bg-indigo-500 text-white" : "bg-white text-slate-500 group-hover:text-indigo-600"
                                            ...
                                            <div>
                                                <div className="flex justify-between items-start mb-3">
                                                    ...
                                                    <span className={`text-[8px] px-2.5 py-0.5 rounded-full font-black uppercase tracking-wider ${
                                                        book.available ? "bg-emerald-50 text-emerald-700 border border-emerald-100" : "bg-rose-50 text-rose-700 border border-rose-100"
