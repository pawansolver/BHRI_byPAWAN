...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        ...
        "desc": "Natural-looking, highly durable permanent teeth replacements.",
        "icon": "TeethIcon"
    },
    {
        "title": "Aesthetic Braces",
        "desc": "Perfecting teeth alignment using modern invisible braces.",
        "icon": "Award"
    },
    {
        "title": "Maxillofacial Trauma Recovery",
        "desc": "Restoring facial structure and bite function post-trauma.",
        "icon": "Stethoscope"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Advanced Dental Care, Maxillofacial Surgery & Aesthetics
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Provides complete oral healthcare, from routine root canal procedures and implants to advanced reconstructive jaw trauma surgeries.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["TeethIcon"], title: "Conservative Dentistry", desc: "Managing root canals, dental restorations, and pulp therapy." },
                            { icon: iconMapping["Stethoscope"], title: "Maxillofacial Surgery", desc: "Surgical jaw trauma corrections, reconstructive work, and wisdom tooth extractions." },
                            { icon: iconMapping["Award"], title: "Orthodontics", desc: "Aesthetic braces, dental alignments, and orthopedic bite alignments." },
                            { icon: iconMapping["ShieldCheck"], title: "Prosthodontics", desc: "Crowns, cosmetic veneers, bridges, and complete dental implants." },
                            { icon: iconMapping["Baby"], title: "Pedodontics", desc: "Compassionate, gentle dental checkups and cavity prevention in children." },
                            { icon: iconMapping["Layers"], title: "Periodontics", desc: "Gum surgery, plaque removal, and systemic oral disease prevention." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(20,184,166,0.12)] hover:border-teal-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-teal-600 group-hover:bg-gradient-to-r from-teal-600 to-emerald-600 shadow-teal-600/30 hover:shadow-teal-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-teal-600 shadow-sm group-hover:bg-gradient-to-r from-teal-600 to-emerald-600 shadow-teal-600/30 hover:shadow-teal-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Electronic Dental Chairs", desc: "Spacious diagnostic setups with adjustable patient control." },
                            { icon: iconMapping["Monitor"], title: "Digital Dental RVG X-Ray", desc: "High-speed, low-dose dental imaging sensor suites." },
                            { icon: iconMapping["ShieldCheck"], title: "Sterile Autoclave Lab", desc: "Advanced dental tool sterilization units." },
                            { icon: iconMapping["TeethIcon"], title: "Implants Micro-Surgery OT", desc: "Modular surgeries for permanent tooth replacement." },
                            { icon: iconMapping["Database"], title: "Prosthetic Casting Lab", desc: "Precise custom crown and denture modeling." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-teal-600 group-hover:bg-gradient-to-r from-teal-600 to-emerald-600 shadow-teal-600/30 hover:shadow-teal-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Dentistry academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Dental Implant & Aesthetic smile clinic
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with modern dental casting labs, our clinic coordinates high-grade dental implant restorations and invisible orthodontic alignments.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Tooth casting simulations", icon: iconMapping["TeethIcon"] },
                                    { text: "Wisdom teeth extraction steps", icon: iconMapping["ShieldCheck"] },
                                    { text: "Oral cancer screen tests", icon: iconMapping["CheckCircle"] },
                                    { text: "Low-dose dental scan rules", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["TeethIcon"], title: "Single-Visit RCTs", desc: "Painless computerized root canal treatments." },
                            { icon: iconMapping["ShieldCheck"], title: "Maxillofacial Reconstruction", desc: "Excellent recoveries in complex jaw fractures." },
                            { icon: iconMapping["Stethoscope"], title: "High-Grade Implants", desc: "Safe, bio-compatible permanent tooth replacements." },
                            { icon: iconMapping["Users"], title: "Certified Dental Surgeons", desc: "HOD instructors active in oral health clinics." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-teal-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Dentistry
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Dentistry at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-teal-600 to-emerald-600 shadow-teal-600/30 hover:shadow-teal-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
