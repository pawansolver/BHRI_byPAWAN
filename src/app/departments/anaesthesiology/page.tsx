...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Peri-Operative Safety",
        "desc": "Absolute safety and pain-free anesthesia during surgical operations.",
        "icon": "ShieldCheck"
    },
    {
        "title": "Vital Organ Intensive Care",
        "desc": "Continuous ICU surveillance of cardiac and respiratory indicators.",
        "icon": "HeartPulse"
    },
    {
        "title": "Cardiac Life Resuscitations",
        "desc": "ACLS protocols to stabilize severe respiratory/cardiac arrests.",
        "icon": "Award"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Critical Patient Care, Pain Management & Life Support
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Oversees patient safety, pain management, and vital organ monitoring before, during, and after surgical operations, managing critical care and trauma resuscitations.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["ShieldCheck"], title: "General Anaesthesia", desc: "Understanding patient intubation, surgical gas ventilation, and sedation." },
                            { icon: iconMapping["Stethoscope"], title: "Regional Anaesthesia", desc: "Managing spinal, epidural blocks, and targeted peripheral nerve blocks." },
                            { icon: iconMapping["HeartPulse"], title: "Critical Care Recovery", desc: "Monitoring post-surgical vital organs and ventilator support." },
                            { icon: iconMapping["Activity"], title: "Pain Management", desc: "Medical block therapies for chronic spinal and joint pain." },
                            { icon: iconMapping["Award"], title: "Life Support (ACLS)", desc: "Cardiopulmonary resuscitation drills for cardiac and respiratory failures." },
                            { icon: iconMapping["Users"], title: "Pre-Anaesthetic Check", desc: "Evaluating surgical risks and cardiac statuses pre-operation." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(99,102,241,0.12)] hover:border-indigo-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-indigo-600 group-hover:bg-gradient-to-r from-indigo-600 to-blue-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-indigo-600 shadow-sm group-hover:bg-gradient-to-r from-indigo-600 to-blue-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Pre-Operative Check OPD", desc: "Pre-anaesthetic patient assessment rooms." },
                            { icon: iconMapping["Monitor"], title: "Anaesthesia Workstations", desc: "Advanced ventilators, vaporizers, and gas monitoring systems." },
                            { icon: iconMapping["HeartPulse"], title: "Post-Anaesthesia Care (PACU)", desc: "High-vital recovery ICU beds post-surgery." },
                            { icon: iconMapping["Database"], title: "ACLS Resuscitation Bay", desc: "Defibrillators, crash carts, and cardiac monitors." },
                            { icon: iconMapping["ShieldCheck"], title: "Chronic Pain Clinic", desc: "Focused ultrasound-guided nerve blocks." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-indigo-600 group-hover:bg-gradient-to-r from-indigo-600 to-blue-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Anaesthesiology academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Advanced Critical Care Resuscitation
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Our department leads the hospital's trauma and cardiac resuscitations, training students in advanced mechanical ventilation and vascular line access.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Airway intubation sweeps", icon: iconMapping["ShieldCheck"] },
                                    { text: "Epidural surface landmarks", icon: iconMapping["Stethoscope"] },
                                    { text: "Cardiac defibrillator drills", icon: iconMapping["CheckCircle"] },
                                    { text: "Arterial vital monitoring", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Monitor"], title: "Modern Workstations", desc: "Precision gas ventilation controls." },
                            { icon: iconMapping["ShieldCheck"], title: "Safe Spinal Blocks", desc: "Sutureless target regional anesthesias." },
                            { icon: iconMapping["HeartPulse"], title: "24/7 Life Support", desc: "Trained code-blue trauma resuscitation teams." },
                            { icon: iconMapping["Users"], title: "Anesthesiology HODs", desc: "Active intensivists supervising diagnostic checkups." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-indigo-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Anaesthesiology
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Anaesthesiology at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
