...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Advanced CT & MRI Diagnostics",
        "desc": "Highly detailed scans for absolute diagnostic precision.",
        "icon": "Microscope"
    },
    {
        "title": "Fetal Doppler Ultrasound",
        "desc": "HD 3D/4D scans to monitor pregnancy development.",
        "icon": "Activity"
    },
    {
        "title": "Interventional Imaging",
        "desc": "Precision vascular therapies guided by digital imaging.",
        "icon": "Target"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Advanced Medical Imaging & Precise Diagnostics
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>The department serves as the hospital's diagnostic compass, using cutting-edge X-Ray, CT-Scan, MRI, and Ultrasound imaging to visualize anatomical structures.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Microscope"], title: "Diagnostic Radiology", desc: "Reading high-definition digital musculoskeletal X-Rays." },
                            { icon: iconMapping["Activity"], title: "Ultrasonography", desc: "Understanding Doppler blood flow and 3D/4D fetal scans." },
                            { icon: iconMapping["Stethoscope"], title: "Computed Tomography (CT)", desc: "Analyzing multi-slice head, abdominal, and chest CT scans." },
                            { icon: iconMapping["ShieldCheck"], title: "Magnetic Resonance (MRI)", desc: "Soft-tissue diagnostic imaging, joint ligaments, and brain scans." },
                            { icon: iconMapping["Target"], title: "Interventional Radiology", desc: "Minimally invasive therapies guided by live imaging." },
                            { icon: iconMapping["Award"], title: "Radiation Safety", desc: "Enforcing safe low-dose radiological protocols (ALARA)." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                            ...
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-indigo-600 group-hover:bg-gradient-to-r from-indigo-600 to-violet-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 group-hover:text-white transition-all shadow-sm">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    "Identifying diagnostic landmarks on digital X-Rays",
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-indigo-600 shadow-sm group-hover:bg-gradient-to-r from-indigo-600 to-violet-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Multislice CT Scanner Suite", desc: "High-speed multi-row diagnostic scanning systems." },
                            { icon: iconMapping["Microscope"], title: "High-Field MRI Unit", desc: "HD soft-tissue imaging and joint evaluations." },
                            { icon: iconMapping["Monitor"], title: "Digital X-Ray Rooms", desc: "Shielded, high-frequency low-dose X-Ray bays." },
                            { icon: iconMapping["Database"], title: "Color Doppler USG Clinic", desc: "Advanced diagnostic fetal and vascular doppler scanners." },
                            { icon: iconMapping["ShieldCheck"], title: "PACS Network Servers", desc: "Instant clinical imaging distribution systems." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-indigo-600 group-hover:bg-gradient-to-r from-indigo-600 to-violet-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Radiology academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with high-resolution doppler imaging, our scanning labs support precise fetal organ evaluations and rapid vascular screenings.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Anatomical X-ray evaluations", icon: iconMapping["Microscope"] },
                                    { text: "Bedside ultrasound observations", icon: iconMapping["ShieldCheck"] },
                                    { text: "Cross-sectional CT/MRI audits", icon: iconMapping["CheckCircle"] },
                                    { text: "ALARA radiation protection", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Microscope"], title: "High-Field MRI Systems", desc: "Highly precise soft tissue and joint scans." },
                            { icon: iconMapping["ShieldCheck"], title: "Fast-Scan CT Scanners", desc: "Safe, rapid trauma computed tomographies." },
                            { icon: iconMapping["Monitor"], title: "Low-Dose Digital X-Ray", desc: "Ensuring minimal exposure for patient safety." },
                            { icon: iconMapping["Users"], title: "Radiological Pioneers", desc: "HOD doctors available for clinical imaging audits." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Radiology
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Radiology at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 shadow-indigo-600/30 hover:shadow-indigo-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
