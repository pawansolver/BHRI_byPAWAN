...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Advanced Laser Skin Care",
        "desc": "Clear and glowing skin via micro-laser resurfacing.",
        "icon": "Sparkles"
    },
    {
        "title": "Clinical Dermatology",
        "desc": "Long-term relief from eczema and complex psoriasis.",
        "icon": "Stethoscope"
    },
    {
        "title": "Hair & Nail Restoration",
        "desc": "Specialized trichology and micro-surgical options.",
        "icon": "Activity"
    }
];
        ...
        <div className="bg-white min-h-screen relative overflow-hidden" style={{ fontFamily: sansFont }}>
            ...
            <section className="relative h-[75vh] min-h-[500px] flex items-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <Image 
                        src="/carousel-2.png"
                        alt="Dermatology, Venereology & Leprosy"
                        fill
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Clinical Skin Care, Laser Surgery & Wellness
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Provides expert clinical care for complex skin conditions, hair and nail disorders, leprosy, and reproductive tract infections, using advanced medical treatments and cosmetic lasers.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Sparkles"], title: "Clinical Dermatology", desc: "Managing chronic eczema, psoriasis, acne, and immune skin lesions." },
                            { icon: iconMapping["Stethoscope"], title: "Cosmetic Dermato-Surgery", desc: "Laser resurfacing, microdermabrasion, and minor skin grafting." },
                            { icon: iconMapping["Activity"], title: "Trichology & Onychology", desc: "Treating hair-loss conditions and nail plate deformities surgically." },
                            { icon: iconMapping["ShieldCheck"], title: "Venereology", desc: "Diagnosing and managing sexually transmitted reproductive infections." },
                            { icon: iconMapping["Award"], title: "Leprosy Care", desc: "Multi-drug chemotherapy regimens and peripheral nerve rehabilitation." },
                            { icon: iconMapping["Layers"], title: "Phototherapy", desc: "Applying clinical UV light exposure for vitiligo and lesions." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                            ...
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-amber-600 group-hover:bg-gradient-to-r from-amber-600 to-amber-700 shadow-amber-600/30 hover:shadow-amber-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-amber-600 shadow-sm group-hover:bg-gradient-to-r from-amber-600 to-amber-700 shadow-amber-600/30 hover:shadow-amber-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Dermatology Outpatient", desc: "Spacious consulting rooms with minor surgical blocks." },
                            { icon: iconMapping["Sparkles"], title: "Laser Surgery center", desc: "High-precision cosmetic laser resurfacing units." },
                            { icon: iconMapping["Monitor"], title: "Focused Phototherapy Station", desc: "Calibrated narrow-band UVB phototherapy cabins." },
                            { icon: iconMapping["Database"], title: "Minor Operation Theatre", desc: "Sterile surgical bays for skin and nail biopsies." },
                            { icon: iconMapping["ShieldCheck"], title: "Trichology Scanning Lab", desc: "Digital dermoscopes for automated hair follicle assessments." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-amber-600 group-hover:bg-gradient-to-r from-amber-600 to-amber-700 shadow-amber-600/30 hover:shadow-amber-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Dermatology, Venereology & Leprosy academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Cosmetic Dermato-Surgery & Laser Center
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with advanced laser therapy setups, our cosmetic center delivers painless, sutureless scar revisions and skin restorations.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "KOH fungal diagnostics", icon: iconMapping["Sparkles"] },
                                    { text: "Laser resurfacing drills", icon: iconMapping["ShieldCheck"] },
                                    { text: "Precision skin biopsy steps", icon: iconMapping["CheckCircle"] },
                                    { text: "Phototherapy UV safety rules", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Sparkles"], title: "Cosmetic Lasers", desc: "State-of-the-art scar and skin revision work." },
                            { icon: iconMapping["ShieldCheck"], title: "Sutureless Biopsies", desc: "Clean, painless tissue screening procedures." },
                            { icon: iconMapping["Stethoscope"], title: "Focused Phototherapy", desc: "Successful target vitiligo therapies." },
                            { icon: iconMapping["Users"], title: "Expert Dermatologists", desc: "Academic MD instructors active in diagnostic clinics." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Dermatology, Venereology & Leprosy
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Dermatology, Venereology & Leprosy at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-amber-600 to-amber-700 shadow-amber-600/30 hover:shadow-amber-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
