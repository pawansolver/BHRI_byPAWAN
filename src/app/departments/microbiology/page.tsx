...
const iconMapping: Record<string, React.ComponentType<any>> = {
    ...
    Brain, Bone, ShieldAlert, AlertTriangle, BloodDropIcon, JusticeIcon, TeethIcon, HeartPulse, Heart, Award, Clock, Atom
};
...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Pathogen Cultures",
        "desc": "Precise microscopic identification of clinical infectious threats.",
        "icon": "Microscope"
    },
    {
        "title": "Molecular PCR Scans",
        "desc": "High-speed diagnostic sweeps for acute viral infections.",
        "icon": "FlaskConical"
    },
    {
        "title": "Hospital Bio-Safety",
        "desc": "Sterilizing operational theatres and ensuring patient safety.",
        "icon": "ShieldCheck"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Diagnostic Infectious Disease Analysis & Infection Control
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>The department focuses on identifying bacterial, viral, fungal, and parasitic infections. It supports hospital safety through diagnostic cultures and PCR testing.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Microscope"], title: "Bacteriology", desc: "Microscopic isolation and identification of disease-causing bacteria." },
                            { icon: iconMapping["FlaskConical"], title: "Virology", desc: "Viral PCR detection, ELISA assays, and immunodiagnostic markers." },
                            { icon: iconMapping["Atom"], title: "Mycology", desc: "Culture and identification of clinically significant fungal organisms." },
                            { icon: iconMapping["ShieldCheck"], title: "Parasitology", desc: "Microscopic staging of malaria, amoebae, and tissue parasites." },
                            { icon: iconMapping["Stethoscope"], title: "Clinical Immunology", desc: "Serum autoimmune profiling, antibody testing, and antigen checks." },
                            { icon: iconMapping["Users"], title: "Infection Control HOD", desc: "Sterilization standards, hospital waste care, and disinfection audits." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(147,51,234,0.12)] hover:border-purple-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-purple-600 group-hover:bg-gradient-to-r from-purple-600 to-pink-600 shadow-purple-600/30 hover:shadow-purple-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-purple-600 shadow-sm group-hover:bg-gradient-to-r from-purple-600 to-pink-600 shadow-purple-600/30 hover:shadow-purple-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Diagnostic Bacteriology Lab", desc: "Pathogen diagnostic processing and culture setups." },
                            { icon: iconMapping["Microscope"], title: "PCR Molecular Suite", desc: "HD thermocyclers for infectious viral DNA diagnostics." },
                            { icon: iconMapping["Monitor"], title: "Immunodiagnostic Station", desc: "Automated ELISA diagnostic plate readers." },
                            { icon: iconMapping["Database"], title: "Biosafety Cabinet Room", desc: "Level-2 clinical hoods to isolate pathogens safely." },
                            { icon: iconMapping["ShieldCheck"], title: "Autoclave & Sterilizer Lab", desc: "Quality audits for surgical sterilization tools." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-purple-600 group-hover:bg-gradient-to-r from-purple-600 to-pink-600 shadow-purple-600/30 hover:shadow-purple-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Microbiology academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Molecular Diagnostics & PCR Center
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with high-sensitivity PCR setups, our department delivers rapid molecular confirmations for acute respiratory and blood-borne viral pathogens.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Gram-staining diagnosis runs", icon: iconMapping["Microscope"] },
                                    { text: "Agar culture pathogen screens", icon: iconMapping["ShieldCheck"] },
                                    { text: "Antibiotic susceptibility charts", icon: iconMapping["CheckCircle"] },
                                    { text: "High-grade ELISA micro-assays", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Microscope"], title: "Advanced PCR Suites", desc: "High-speed molecular viral diagnostics." },
                            { icon: iconMapping["ShieldCheck"], title: "Antibiotic Profiling", desc: "Expert AST guidance for targeted therapies." },
                            { icon: iconMapping["Stethoscope"], title: "Hospital Clean Audits", desc: "Directing infection control standards." },
                            { icon: iconMapping["Users"], title: "Expert Microbiologists", desc: "Academic guides available in clinical labs." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-purple-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Microbiology
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Microbiology at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-600 shadow-purple-600/30 hover:shadow-purple-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
