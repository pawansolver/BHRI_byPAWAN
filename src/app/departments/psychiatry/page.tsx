...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Empathetic Psychotherapy",
        "desc": "Restoring cognitive balance through expert clinical counseling.",
        "icon": "Brain"
    },
    {
        "title": "Substance De-Addiction",
        "desc": "Integrated medical and psychological de-addiction programs.",
        "icon": "ShieldCheck"
    },
    {
        "title": "Child Behavioral Clinic",
        "desc": "Early intervention plans for childhood developmental deficits.",
        "icon": "Baby"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Empathetic Mental Healthcare & Cognitive Wellness
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Addresses the full spectrum of mental health disorders, substance abuse, and cognitive conditions, combining pharmacological management with advanced psychotherapy.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Brain"], title: "General Psychiatry", desc: "Clinical profiling of depression, anxiety, and bipolar states." },
                            { icon: iconMapping["Baby"], title: "Child & Teen Behavioral", desc: "Understanding ADHD, autism spectrums, and childhood learning deficits." },
                            { icon: iconMapping["ShieldCheck"], title: "Addiction Medicine", desc: "Comprehensive substance de-addiction programs." },
                            { icon: iconMapping["Clock"], title: "Geriatric Psychiatry", desc: "Evaluating dementia, Alzheimer's, and late-onset mood anomalies." },
                            { icon: iconMapping["Activity"], title: "Neuropsychiatry", desc: "Exploring psychiatric features of organic neuro-diseases." },
                            { icon: iconMapping["Users"], title: "Psychotherapy & CBT", desc: "Cognitive Behavioral Therapy and patient counseling modules." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(79,70,229,0.12)] hover:border-indigo-200 relative overflow-hidden"
                            >
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Private Counseling Chambers", desc: "Quiet, calm clinical spaces for confidential counseling." },
                            { icon: iconMapping["ShieldCheck"], title: "Addiction Rehab Clinic", desc: "Focused de-addiction and detox therapy units." },
                            { icon: iconMapping["Monitor"], title: "Neuro-Diagnostic EEG Lab", desc: "HD electroencephalography brain wave recorders." },
                            { icon: iconMapping["Database"], title: "Child Guidance Center", desc: "Focused counseling for developmental learning issues." },
                            { icon: iconMapping["Users"], title: "Cognitive Therapy Halls", desc: "Spacious group-therapy and wellness halls." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Psychiatry academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                De-Addiction & Behavioral Counseling
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Our center integrates psychiatry and psychotherapy, guiding patients out of severe substance dependencies with absolute care and confidentiality.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Structured MSE diagnostics", icon: iconMapping["Brain"] },
                                    { text: "Psychiatric history templates", icon: iconMapping["ShieldCheck"] },
                                    { text: "EEG wave analysis systems", icon: iconMapping["CheckCircle"] },
                                    { text: "Cognitive therapy protocols", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Brain"], title: "Private Counseling", desc: "100% confidential clinical therapy chambers." },
                            { icon: iconMapping["ShieldCheck"], title: "Focused De-Addiction", desc: "Excellent rates of patient dependency recovery." },
                            { icon: iconMapping["Baby"], title: "Child Behavioral Guidance", desc: "Dedicated plans for early cognitive growth." },
                            { icon: iconMapping["Users"], title: "Experienced Counselors", desc: "Dedicated team of active psychiatrists." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Psychiatry at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
