...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Sutureless Laparoscopy",
        "desc": "Rapid recovery gallbladder and appendix repairs via keyhole surgeries.",
        "icon": "Stethoscope"
    },
    {
        "title": "Abdominal Gastro Surgery",
        "desc": "Advanced digestive tract resections with high survival rates.",
        "icon": "FlaskConical"
    },
    {
        "title": "Emergency Surgical Care",
        "desc": "Rapid, highly professional trauma response during critical wound states.",
        "icon": "Activity"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Precision Surgical Care & Laparoscopic Innovation
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Specializes in surgical interventions of the abdomen, thyroid, breast, and soft tissues, pioneering minimally invasive keyhole laparoscopy.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Stethoscope"], title: "Laparoscopic Surgery", desc: "Learning minimally invasive keyhole gallbladder, appendix, and hernia repairs." },
                            { icon: iconMapping["FlaskConical"], title: "Gastrointestinal Surgery", desc: "Surgical resection of stomach, bowel, and colon diseases." },
                            { icon: iconMapping["ShieldCheck"], title: "Endocrine Surgery", desc: "Precision thyroidectomies and adrenal gland surgical interventions." },
                            { icon: iconMapping["HeartPulse"], title: "Breast Oncology", desc: "Comprehensive screening, lump removals, and mastectomy procedures." },
                            { icon: iconMapping["Activity"], title: "Trauma Wound Surgery", desc: "Rapid clinical care for open injuries and emergency lacerations." },
                            { icon: iconMapping["Users"], title: "Podiatric Wound Clinic", desc: "Comprehensive vascular diagnostics and diabetic foot ulcer care." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(239,68,68,0.12)] hover:border-red-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-red-600 group-hover:bg-gradient-to-r from-red-600 to-red-700 shadow-red-600/30 hover:shadow-red-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-red-600 shadow-sm group-hover:bg-gradient-to-r from-red-600 to-red-700 shadow-red-600/30 hover:shadow-red-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Modular Surgical OTs", desc: "Clean operating rooms with absolute air filtration." },
                            { icon: iconMapping["Monitor"], title: "Laparoscopic HD Cameras", desc: "HD monitor and scope systems for keyhole surgeries." },
                            { icon: iconMapping["Stethoscope"], title: "Surgical OPD Consulting", desc: "Diagnostic OPD suites for surgical planning." },
                            { icon: iconMapping["Database"], title: "Post-Operative Recovery", desc: "Integrated post-surgery monitoring beds." },
                            { icon: iconMapping["ShieldCheck"], title: "Surgical Dressing Clinic", desc: "Dedicated clean dressings and wound reviews." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-red-600 group-hover:bg-gradient-to-r from-red-600 to-red-700 shadow-red-600/30 hover:shadow-red-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            General Surgery academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with high-definition laparoscopes, our surgical teams complete sutureless keyhole procedures, allowing patients to recover rapidly.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Suturing & knotting drills", icon: iconMapping["Stethoscope"] },
                                    { text: "Sterile OT prep steps", icon: iconMapping["ShieldCheck"] },
                                    { text: "Laparoscopic monitor feeds", icon: iconMapping["CheckCircle"] },
                                    { text: "Wound care dressings", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Stethoscope"], title: "Keyhole Surgery", desc: "Advanced sutureless laparoscopic OTs." },
                            { icon: iconMapping["ShieldCheck"], title: "Rapid Trauma Care", desc: "Emergency suturing available 24/7." },
                            { icon: iconMapping["HeartPulse"], title: "Diabetic Foot Care", desc: "Dedicated vascular and wound clinics." },
                            { icon: iconMapping["Users"], title: "Master Gastro Surgeons", desc: "Academic MD instructors active in diagnostic wards." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-red-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in General Surgery
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of General Surgery at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-red-600 to-red-700 shadow-red-600/30 hover:shadow-red-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
