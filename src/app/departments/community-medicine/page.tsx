...
const iconMapping: Record<string, React.ComponentType<any>> = {
    ...
    Brain, Bone, ShieldAlert, AlertTriangle, BloodDropIcon, JusticeIcon, TeethIcon, HeartPulse, Heart, Award, Clock, Globe, Building2
};
...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        ...
        "desc": "Immunizing societies and ending disease outbreaks systematically.",
        "icon": "ShieldCheck"
    },
    {
        "title": "Rural Health Outreach",
        "desc": "Active diagnostic camps in remote villages and health training.",
        "icon": "Hospital"
    },
    {
        "title": "Public Health Analytics",
        "desc": "Formulating regional sanitation and nutritional models.",
        "icon": "Globe"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Preventive Care & Universal Health Equity
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>The Department of Community Medicine at Buddha Hospital & Research Institute (BHRI) focuses on health promotion, preventive medicine, epidemiology, and community health development, bridging hospital excellence directly with rural households.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Globe"], title: "Epidemiological Studies", desc: "Evaluating disease patterns and vectors across population demographics." },
                            { icon: iconMapping["Database"], title: "Biostatistics", desc: "Applying statistical models to analyze community clinical data." },
                            { icon: iconMapping["HeartPulse"], title: "Environmental Health", desc: "Enforcing clean sanitation, water safety, and waste processing rules." },
                            { icon: iconMapping["Baby"], title: "Family Medicine & Nutrition", desc: "Focused maternal, child nutrition, and gestational health monitoring." },
                            { icon: iconMapping["ShieldCheck"], title: "National Health Plans", desc: "Systematic execution of TB, malaria, and pandemic control programs." },
                            { icon: iconMapping["Hospital"], title: "Primary Healthcare Care", desc: "Running health training and delivery centers in rural settings." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(16,185,129,0.12)] hover:border-emerald-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-emerald-600 group-hover:bg-gradient-to-r from-emerald-600 to-teal-600 shadow-emerald-600/30 hover:shadow-emerald-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-emerald-600 shadow-sm group-hover:bg-gradient-to-r from-emerald-600 to-teal-600 shadow-emerald-600/30 hover:shadow-emerald-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Rural Training Center", desc: "Fully operational rural diagnostic and medical care outpost." },
                            { icon: iconMapping["Building2"], title: "Urban Training Center", desc: "Urban primary healthcare training wing." },
                            { icon: iconMapping["Database"], title: "Health Exhibition Museum", desc: "Exhaustive sets of vectors, charts, and vaccine cold-chains." },
                            { icon: iconMapping["Monitor"], title: "Biostatistical Data Lab", desc: "Analytical software systems to calculate public health indices." },
                            { icon: iconMapping["ShieldCheck"], title: "Vaccine Cold-Chain Station", desc: "Precision temperature-controlled pharmaceutical vaccine storage." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-emerald-600 group-hover:bg-gradient-to-r from-emerald-600 to-teal-600 shadow-emerald-600/30 hover:shadow-emerald-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Community Medicine academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Rural Outreach & Immunization
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                The department coordinates extensive rural clinics and free school immunization campaigns, establishing preventive medical security for underserved communities.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Sociological health surveys", icon: iconMapping["Globe"] },
                                    { text: "Environmental water screenings", icon: iconMapping["ShieldCheck"] },
                                    { text: "Rural immunization clinics", icon: iconMapping["CheckCircle"] },
                                    { text: "Health data biostatistics", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Globe"], title: "Universal Direct Care", desc: "Regular clinical outreach in neighboring villages." },
                            { icon: iconMapping["ShieldCheck"], title: "Cold-Chain Vaccines", desc: "Highly optimized children vaccine deliveries." },
                            { icon: iconMapping["Database"], title: "Epidemiological Research", desc: "Tracking regional vector-borne illnesses." },
                            { icon: iconMapping["Users"], title: "Dedicated Field Experts", desc: "Coordinating rural clinics and primary care hubs." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-emerald-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Community Medicine
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Community Medicine at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 shadow-emerald-600/30 hover:shadow-emerald-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
