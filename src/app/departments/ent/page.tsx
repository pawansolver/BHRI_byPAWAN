...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Hearing Restoration",
        "desc": "Advanced cochlear implants and micro-surgical ear repairs.",
        "icon": "Volume2"
    },
    {
        "title": "Endoscopic Sinus Surgery",
        "desc": "Gentle, precise relief from chronic sinus issues.",
        "icon": "Stethoscope"
    },
    {
        "title": "Voice & Throat Care",
        "desc": "Professional Swallowing and vocal rehabilitation therapies.",
        "icon": "Activity"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Surgical and Medical Excellence in Ear, Nose & Throat
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Provides comprehensive medical and surgical management for disorders of the ear, nose, throat, and related structures of the head and neck, including hearing and speech restoration.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Volume2"], title: "Otology", desc: "Diagnosing ear diseases, hearing loss, and performing cochlear implants." },
                            { icon: iconMapping["Stethoscope"], title: "Rhinology", desc: "Treating complex sinus conditions and performing micro-endoscopic surgeries." },
                            { icon: iconMapping["Activity"], title: "Laryngology", desc: "Evaluating voice disorders, swallowing anomalies, and vocal cord therapies." },
                            { icon: iconMapping["ShieldCheck"], title: "Head & Neck Oncology", desc: "Surgical oncology interventions for tumors of the head, neck, and throat." },
                            { icon: iconMapping["Baby"], title: "Pediatric ENT", desc: "Caring for congenital pediatric airways and pediatric hearing assessments." },
                            { icon: iconMapping["Users"], title: "Audiology & Speech", desc: "Speech pathology, hearing-aid calibration, and linguistic rehab." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(6,182,212,0.12)] hover:border-cyan-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-cyan-600 group-hover:bg-gradient-to-r from-cyan-600 to-blue-600 shadow-cyan-600/30 hover:shadow-cyan-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-cyan-600 shadow-sm group-hover:bg-gradient-to-r from-cyan-600 to-blue-600 shadow-cyan-600/30 hover:shadow-cyan-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "ENT Specialized Clinics", desc: "Dedicated OPD suites for detailed diagnosis." },
                            { icon: iconMapping["Volume2"], title: "Audiology Testing Lab", desc: "Sound-proof rooms for pure-tone and tympanometry checks." },
                            { icon: iconMapping["Monitor"], title: "Sinus Endoscopy Suite", desc: "HD fiber-optic nasal diagnostic endoscopes." },
                            { icon: iconMapping["Database"], title: "Micro-Ear Surgery OT", desc: "Modular operating systems for sensory reconstruction." },
                            { icon: iconMapping["ShieldCheck"], title: "Speech Pathology Wing", desc: "Rehabilitation setups for post-stroke voice deficits." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-cyan-600 group-hover:bg-gradient-to-r from-cyan-600 to-blue-600 shadow-cyan-600/30 hover:shadow-cyan-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Oto-Rhino-Laryngology (ENT) academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Micro-Ear & Hearing Aid Clinic
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with state-of-the-art audiological diagnostics, the department coordinates cochlear implant programs and specialized voice rehabilitation therapies.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Pure-tone audiology sweeps", icon: iconMapping["Volume2"] },
                                    { text: "Endoscopic nasal diagnostics", icon: iconMapping["ShieldCheck"] },
                                    { text: "Micro-ear surgery simulations", icon: iconMapping["CheckCircle"] },
                                    { text: "Speech evaluation diagnostics", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Volume2"], title: "Micro-Ear Surgery", desc: "High-precision sensory hearing restorations." },
                            { icon: iconMapping["Stethoscope"], title: "Endoscopic Sinus", desc: "Advanced sinus relief procedures." },
                            { icon: iconMapping["Activity"], title: "Voice Care Clinics", desc: "Detailed vocal fold diagnostic analysis." },
                            { icon: iconMapping["Users"], title: "Certified ENT Surgeons", desc: "Academic guides directing diagnostic labs." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-cyan-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Oto-Rhino-Laryngology (ENT)
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Oto-Rhino-Laryngology (ENT) at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 shadow-cyan-600/30 hover:shadow-cyan-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
