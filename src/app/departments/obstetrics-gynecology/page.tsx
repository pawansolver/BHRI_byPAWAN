...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Safe Maternity",
        "desc": "Compassionate, high-standard clinical care for mother and baby.",
        "icon": "Heart"
    },
    {
        "title": "Laparoscopic Gynecology",
        "desc": "Minimal-access surgeries ensuring rapid physical recoveries.",
        "icon": "Stethoscope"
    },
    {
        "title": "Infertility & PCOS Care",
        "desc": "Comprehensive hormonal and reproductive recovery programs.",
        "icon": "Activity"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Comprehensive Health for Women & Safe Maternity Care
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Provides comprehensive diagnostic and surgical care for women's reproductive health, prenatal/pregnancy monitoring, labor delivery, and postnatal support.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Heart"], title: "Antenatal Care", desc: "Pre-pregnancy counselling and tracking gestational safety milestones." },
                            { icon: iconMapping["ShieldCheck"], title: "High-Risk Obstetrics", desc: "Caring for severe complications like pre-eclampsia and gestational diabetes." },
                            { icon: iconMapping["Stethoscope"], title: "Gynaec Laparoscopy", desc: "Keyhole laparoscopic hysterectomies and cyst removals." },
                            { icon: iconMapping["Activity"], title: "Infertility Clinic", desc: "Advanced diagnostics and metabolic therapies for PCOS." },
                            { icon: iconMapping["Baby"], title: "Postnatal Support", desc: "Lactation guidance, neonatal bonding, and mother wellness." },
                            { icon: iconMapping["Layers"], title: "Onco-Gynaecology", desc: "Preventive screenings, pap smears, and clinical cervical cancer checks." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(244,63,94,0.12)] hover:border-rose-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-rose-600 group-hover:bg-gradient-to-r from-rose-600 to-purple-600 shadow-rose-600/30 hover:shadow-rose-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-rose-600 shadow-sm group-hover:bg-gradient-to-r from-rose-600 to-purple-600 shadow-rose-600/30 hover:shadow-rose-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Modern Labor Suites", desc: "Hygienic, comfortable delivery and labor rooms." },
                            { icon: iconMapping["ShieldCheck"], title: "High-Risk Pregnancy OPD", desc: "Advanced pregnancy complications screening units." },
                            { icon: iconMapping["Monitor"], title: "Laparoscopic Gynaec OT", desc: "State-of-the-art keyhole surgical monitors." },
                            { icon: iconMapping["Database"], title: "Fetal Medicine Station", desc: "3D/4D ultrasound fetal health scanning." },
                            { icon: iconMapping["Baby"], title: "Postnatal Recovery Bays", desc: "Spacious mother-child care recovery rooms." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-rose-600 group-hover:bg-gradient-to-r from-rose-600 to-purple-600 shadow-rose-600/30 hover:shadow-rose-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Obstetrics & Gynecology academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Equipped with advanced CTG monitoring, our maternity units coordinate rapid responses for complicated labor states, ensuring maternal-fetal safety.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Antenatal diagnosis runs", icon: iconMapping["Heart"] },
                                    { text: "Normal delivery simulators", icon: iconMapping["ShieldCheck"] },
                                    { text: "Laparoscopic surgery reviews", icon: iconMapping["CheckCircle"] },
                                    { text: "CTG fetal health tracking", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Heart"], title: "Safe Deliveries", desc: "Excellent tracking records in labor emergencies." },
                            { icon: iconMapping["ShieldCheck"], title: "Keyhole Laparoscopy", desc: "Quick recovery gynaecological surgeries." },
                            { icon: iconMapping["Stethoscope"], title: "Painless Delivery", desc: "Modern epidural options for pain-free labor." },
                            { icon: iconMapping["Users"], title: "Renowned Obstetricians", desc: "Senior MD doctors active in clinics." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                            ...
                            >
                                <div>
                                    <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-rose-600">
                                        <stat.icon size={20} />
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Obstetrics & Gynecology
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Obstetrics & Gynecology at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-rose-600 to-purple-600 shadow-rose-600/30 hover:shadow-rose-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
