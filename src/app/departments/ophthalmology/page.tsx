...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        "title": "Sutureless Cataract Surgery",
        "desc": "Full visual clarity restored inside a single day.",
        "icon": "Eye"
    },
    {
        "title": "Glaucoma Protections",
        "desc": "Targeted control of intraocular pressure to guard nerves.",
        "icon": "ShieldCheck"
    },
    {
        "title": "Pediatric Squint Correction",
        "desc": "Early intervention to help childhood squints.",
        "icon": "Baby"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Restoring Clear Vision & Advanced Eye Care
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Dedicated to the medical and surgical treatment of eye conditions, providing advanced micro-surgical treatment for cataracts, glaucoma, and refractive errors.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["Eye"], title: "Cataract Surgery", desc: "Learning sutureless high-precision micro-phacoemulsification." },
                            { icon: iconMapping["ShieldCheck"], title: "Glaucoma Clinic", desc: "Controlling intraocular pressure and protecting optic nerves." },
                            { icon: iconMapping["Target"], title: "Retinal Diagnostics", desc: "Diabetic retinopathy screens and medical laser treatments." },
                            { icon: iconMapping["Activity"], title: "Refractive Surgery", desc: "Innovative lasik and refractive vision restorations." },
                            { icon: iconMapping["Baby"], title: "Pediatric Eye Care", desc: "Treating childhood squints and pediatric vision impairments." },
                            { icon: iconMapping["Layers"], title: "Corneal Diseases", desc: "Diagnosing corneal scarring and keratoplasty procedures." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
                                ...
                                whileHover={{ y: -6 }}
                                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 transition-all duration-300 group hover:shadow-[0_20px_45px_rgba(59,130,246,0.12)] hover:border-blue-200 relative overflow-hidden"
                            >
                                ...
                                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 text-blue-600 group-hover:bg-gradient-to-r from-blue-600 to-sky-600 shadow-blue-600/30 hover:shadow-blue-600/50 group-hover:text-white transition-all shadow-sm">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-blue-600 shadow-sm group-hover:bg-gradient-to-r from-blue-600 to-sky-600 shadow-blue-600/30 hover:shadow-blue-600/50 group-hover:text-white transition-all">
                                            <Check size={16} />
                                        </div>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "Comprehensive Eye OPD", desc: "Spacious consulting rooms with refraction blocks." },
                            { icon: iconMapping["Eye"], title: "Phacoemulsification OT", desc: "Modular micro-surgery suites with HD microscopes." },
                            { icon: iconMapping["Monitor"], title: "Computer Refraction Lab", desc: "Automated vision refraction systems." },
                            { icon: iconMapping["Database"], title: "Retinal Laser Suite", desc: "HD fundus cameras and double-frequency YAG lasers." },
                            { icon: iconMapping["ShieldCheck"], title: "Visual Aids center", desc: "Low-vision screening and optical aids." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                            ...
                            >
                                <div>
                                    <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mx-auto mb-6 text-blue-600 group-hover:bg-gradient-to-r from-blue-600 to-sky-600 shadow-blue-600/30 hover:shadow-blue-600/50 group-hover:text-white transition-colors">
                                        <item.icon size={22} />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            Ophthalmology academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Advanced Laser Refractive Center
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                Features the latest generation of automated laser refractor technology to perform quick and completely painless sutureless vision restorations.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "Slit-lamp ocular checks", icon: iconMapping["Eye"] },
                                    { text: "Fundus retinal scanning", icon: iconMapping["ShieldCheck"] },
                                    { text: "Micro-phaco eye surgeries", icon: iconMapping["CheckCircle"] },
                                    { text: "Painless refraction tests", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["Eye"], title: "Sutureless Phaco", desc: "Painless single-day cataract surgeries." },
                            { icon: iconMapping["ShieldCheck"], title: "Retinal Lasers", desc: "Protecting vision from diabetic damage." },
                            { icon: iconMapping["Activity"], title: "Auto-Refraction Labs", desc: "Precise optical power evaluations." },
                            { icon: iconMapping["Users"], title: "Certified Eye HODs", desc: "Instructors available for clinical diagnostic guides." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in Ophthalmology
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of Ophthalmology at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            <motion.a 
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-10 py-4 bg-gradient-to-r from-blue-600 to-sky-600 shadow-blue-600/30 hover:shadow-blue-600/50 text-white font-bold rounded-full shadow-2xl text-lg transition-all"
                            >
                                Contact Department
                            </motion.a>
                        </div>
