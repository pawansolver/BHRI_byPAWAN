...
export default function DepartmentPage() {
    ...
    const slides = [
    {
        ...
        "desc": "Constant ICU organ-support monitoring for acute emergencies.",
        "icon": "HeartPulse"
    },
    {
        "title": "Metabolic Management",
        "desc": "Advanced therapies for diabetes and thyroid hormone issues.",
        "icon": "Stethoscope"
    },
    {
        "title": "Diagnostic Mysteries",
        "desc": "Solving complex multi-system clinical diagnostic cases.",
        "icon": "Activity"
    }
];
                ...
                <div className="relative z-20 container mx-auto px-6 lg:px-12 text-left max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-xl lg:text-2xl text-slate-300 font-medium max-w-2xl mb-10 leading-relaxed drop-shadow-md">
                            Holistic Diagnostic Care & Therapeutic Excellence
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
                                <p>Serves as the foundation of hospital care, managing patients with complex, multi-system diseases, infections, chronic conditions, and diagnostic challenges.</p>
                                <p>
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { icon: iconMapping["HeartPulse"], title: "Infectious Diseases", desc: "Diagnosing viral, bacterial, and tropical epidemics systematically." },
                            { icon: iconMapping["Stethoscope"], title: "Endocrinology", desc: "Specialist management of diabetes, thyroid, and metabolic imbalances." },
                            { icon: iconMapping["Activity"], title: "Cardiology Basics", desc: "Hypertension diagnostics, coronary evaluations, and medical care." },
                            { icon: iconMapping["ShieldCheck"], title: "Nephrology Care", desc: "Medical management of chronic kidney disease and electrolyte balances." },
                            { icon: iconMapping["Layers"], title: "Rheumatology", desc: "Caring for rheumatoid arthritis and autoimmune inflammatory diseases." },
                            { icon: iconMapping["Users"], title: "Geriatric Medicine", desc: "Focused primary care for physical and cognitive elderly concerns." }
                        ].map((area, idx) => (
                            <motion.div 
                                key={idx}
            ...
            <section className="py-20 lg:py-32 bg-slate-50 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { icon: iconMapping["Hospital"], title: "General Outpatient Clinics", desc: "Spacious diagnostic halls serving daily outpatients." },
                            { icon: iconMapping["Activity"], title: "Medical Intensive Care Unit", desc: "Multi-parameter ICU beds for life support." },
                            { icon: iconMapping["Monitor"], title: "Cardiac Stress Lab", desc: "Treadmill testing, Echo, and ECG scanning suites." },
                            { icon: iconMapping["Database"], title: "Diabetic Care Center", desc: "Focused clinical counseling and insulin training." },
                            { icon: iconMapping["ShieldCheck"], title: "Dialysis Support Wing", desc: "Clean, sterilized vascular filtration setups." }
                        ].map((item, idx) => (
                            <motion.div 
                                key={idx}
                                initial={{ opacity: 0, scale: 0.95 }}
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-500 max-w-3xl mx-auto mt-4 text-base lg:text-lg leading-relaxed">
                            General Medicine academics is led by senior specialist doctors, training students through standard case discussions, dynamic practical runs, and critical ward observations.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <h2 className="text-3xl lg:text-5xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                                Metabolic & Diabetes Care Center
                            </h2>
                            <p className="text-slate-400 text-lg leading-relaxed mb-10">
                                The department drives comprehensive metabolic screenings and diet charts, ensuring chronic diabetes is managed seamlessly at all clinical stages.
                            </p>
                            
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    { text: "ECG diagnostic assessments", icon: iconMapping["Activity"] },
                                    { text: "Fluid aspiration procedures", icon: iconMapping["ShieldCheck"] },
                                    { text: "ABG respiratory diagnostics", icon: iconMapping["CheckCircle"] },
                                    { text: "Bedside ICU patient care", icon: iconMapping["Target"] }
                                ].map((item, i) => (
            ...
            <section className="py-20 lg:py-24 bg-gradient-to-b from-white to-slate-50 border-b border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                            { icon: iconMapping["HeartPulse"], title: "24/7 Intensive Care", desc: "Excellent post-surgery and emergency ICUs." },
                            { icon: iconMapping["Stethoscope"], title: "Diagnostic Excellence", desc: "Expert multidisciplinary diagnostic panels." },
                            { icon: iconMapping["Activity"], title: "Chronic Care Centers", desc: "Successful therapies for long-term health." },
                            { icon: iconMapping["Users"], title: "Renowned Medical Gurus", desc: "Specialist academic HODs directing wards." }
                        ].map((stat, i) => (
                            <motion.div 
                                key={i} 
                                initial={{ opacity: 0, y: 15 }}
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
                    ...
                    >
                        <h2 className="text-4xl lg:text-6xl font-bold mb-8 leading-tight" style={{ fontFamily: serifFont }}>
                            Begin Your Career in General Medicine
                        </h2>
                        <p className="text-lg lg:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Join the Department of General Medicine at BHRI and explore standard clinical, surgical, and preventive diagnostics.
                        </p>
